        ...
        navigator.mediaDevices
            ...
            .then((currentStream) => {
                if (connectionRef.current) {
                    console.log('in changing video device before change connectionRef.current.streams', connectionRef.current.streams);
                    console.log('in changing video device before change connectionRef.current', connectionRef.current.streams);
                    ...
                    console.log('in changing video device after chnage connectionRef.current.streams', connectionRef.current.streams);
                    console.log('in changing video device after chnage connectionRef.current.streams', connectionRef.current.streams);
                }
                ...
                navigator.mediaDevices
                    ...
                    .then((currentStream) => {
                        try {
                            ...
                            console.log('in screen sharing all videoTracks', connectionRef.current.streams);
                            console.log('in screen sharing videoTrack', videoTrack);
                            console.log('in screen sharing screenTrack', screenTrack);
                            if (videoTrack) {
                                connectionRef.current.replaceTrack(videoTrack, screenTrack, connectionRef.current);
                            } else {
                                connectionRef.current.addTrack(screenTrack, connectionRef.current);
                            }
                            ...
                            screenTrack.onended = () => {
                                if (videoTrack) {
                                    connectionRef.current.replaceTrack(screenTrack, videoTrack, connectionRef.current);
                                } else {
                                    connectionRef.current.removeTrack(screenTrack, connectionRef.current);
                                }

                                myVideo.current.srcObject = connectionRef.current;
                            ...
                            console.log('in screen sharing error: ' + error);
