        ...
        <div className="onlineUsersContainer">
            ...
            <div className="selectMediaDevices">
                ...
                <div style={{ flex: 1 }}>
                    ...
                    <div>When you attach a new camera, you have to refresh the web page, in order to use newly attached camera</div>
                </div>
            </div>
                ...
                <div style={{ marginBottom: '0.5rem' }}>
                    ...
                    >
                        ...
                        <div onClick={refreshOnlineUsers}>
                            {refreshing ? <div class="lds-hourglass"></div> : <img src={refresh} width={30} alt="Refresh" />}
                        </div>
                        {/* <div>
                            <label>
                                <input
                                                    ...
                                                    onClick={() => {
                                                        if (!stream) {
                                                            return notifyMe(
                                                                ...
                                                                'Both camera and microphone are not available. Kindly enable them.'
                                                            );
                                                        }
